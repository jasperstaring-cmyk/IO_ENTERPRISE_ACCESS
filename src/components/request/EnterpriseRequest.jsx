    ...
    <div className="detail-card" style={{ maxWidth: 640 }}>
      ...
      <div className="input-group">
        ...
        <select className="input-field" value={country}
          ...
          {COUNTRIES.map((c, i) =>
            c.code === '---'
              ? <option key={i} disabled>{'─'.repeat(30)}</option>
      ...
      <div className="input-group" style={{ marginBottom: '1.25rem' }}>
        ...
        <button type="button"
          className={`sel-row ${accessType === 'whitelist' ? 'selected' : ''}`}
        ...
        <button type="button"
          className={`sel-row ${accessType === 'sso' ? 'selected' : ''}`}
      ...
      <div className="input-group" style={{ marginBottom: '1.25rem' }}>
        ...
        <button type="button"
          className={`sel-row ${editionChoice === 'single' ? 'selected' : ''}`}
        ...
        <button type="button"
          className={`sel-row ${editionChoice === 'all' ? 'selected' : ''}`}
