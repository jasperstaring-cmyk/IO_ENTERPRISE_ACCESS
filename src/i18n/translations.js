...
export const en = {
  ...
  req_badge: "Your subscription",
  req_sidebar_plan_label: "YOUR CHOSEN SUBSCRIPTION",
  req_sidebar_price_label: "YOUR PRICE",
  req_sidebar_price_note: "Price on request",
  req_sidebar_cta: "Your organisation may qualify for free access",
  req_sidebar_features_label: "WHAT YOU GET:",
  req_sidebar_f1: "A tailor-made subscription",
  req_sidebar_f2: "Access to Investmentofficer.nl",
  req_sidebar_f3: "Access to the App",
  req_sidebar_f4: "Access to our newsletters",
  req_sidebar_f5: "Invite up to 100 colleagues",
  req_sidebar_help_title: "Need help?",
  req_sidebar_help_sub: "Ask a question",
}
...
export const nl = {
  ...
  req_badge: "Uw abonnement",
  req_sidebar_plan_label: "UW GEKOZEN ABONNEMENT",
  req_sidebar_price_label: "UW PRIJS",
  req_sidebar_price_note: "Prijs op aanvraag",
  req_sidebar_cta: "Uw organisatie komt mogelijk in aanmerking voor gratis toegang",
  req_sidebar_features_label: "WAT U KRIJGT:",
  req_sidebar_f1: "Een abonnement op maat",
  req_sidebar_f2: "Toegang tot Investmentofficer.nl",
  req_sidebar_f3: "Toegang tot de App",
  req_sidebar_f4: "Toegang tot onze nieuwsbrieven",
  req_sidebar_f5: "Nodig tot 100 collega's uit",
  req_sidebar_help_title: "Hulp nodig?",
  req_sidebar_help_sub: "Stel een vraag",
}
...
export const de = {
  ...
  req_badge: "Ihr Abonnement",
  req_sidebar_plan_label: "IHR GEWÄHLTES ABONNEMENT",
  req_sidebar_price_label: "IHR PREIS",
  req_sidebar_price_note: "Preis auf Anfrage",
  req_sidebar_cta: "Ihre Organisation könnte kostenlosen Zugang erhalten",
  req_sidebar_features_label: "WAS SIE BEKOMMEN:",
  req_sidebar_f1: "Ein maßgeschneidertes Abonnement",
  req_sidebar_f2: "Zugang zu Investmentofficer.nl",
  req_sidebar_f3: "Zugang zur App",
  req_sidebar_f4: "Zugang zu unseren Newslettern",
  req_sidebar_f5: "Laden Sie bis zu 100 Kollegen ein",
  req_sidebar_help_title: "Hilfe benötigt?",
  req_sidebar_help_sub: "Stellen Sie eine Frage",
}
...
export const fr = {
  ...
  req_badge: "Votre abonnement",
  req_sidebar_plan_label: "VOTRE ABONNEMENT CHOISI",
  req_sidebar_price_label: "VOTRE PRIX",
  req_sidebar_price_note: "Prix sur demande",
  req_sidebar_cta: "Votre organisation pourrait bénéficier d'un accès gratuit",
  req_sidebar_features_label: "CE QUE VOUS OBTENEZ :",
  req_sidebar_f1: "Un abonnement sur mesure",
  req_sidebar_f2: "Accès à Investmentofficer.nl",
  req_sidebar_f3: "Accès à l'application",
  req_sidebar_f4: "Accès à nos newsletters",
  req_sidebar_f5: "Invitez jusqu'à 100 collègues",
  req_sidebar_help_title: "Besoin d'aide ?",
  req_sidebar_help_sub: "Posez une question",
}
