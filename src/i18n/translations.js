...
export const en = {
  ...
  cv_section_sub: "View your organisation's SSO connection details.",
  ...
  acc_edit: "Edit",
  cv_access_title: "Your access",
  cv_access_sub: "Your organisation's access configuration. Managed by Investment Officer.",
  cv_access_type_label: "Access type",
  cv_client_id: "Client ID",
  cv_tenant_id: "Tenant ID",
  cv_redirect_uri: "Redirect URI",
...
export const nl = {
  ...
  cv_section_sub: "Bekijk de SSO-verbindingsgegevens van uw organisatie.",
  acc_my_account: "Mijn account",
  acc_newsletter: "Nieuwsbrief",
  acc_subscriptions: "Mijn abonnementen",
  acc_users: "Gebruikers uitnodigen",
  acc_billing: "Facturering",
  acc_help: "HULP NODIG?",
  acc_contact: "Neem contact op",
  acc_edit: "Bewerken",
  cv_access_title: "Uw toegang",
  cv_access_sub: "De toegangsconfiguratie van uw organisatie. Beheerd door Investment Officer.",
  cv_access_type_label: "Toegangstype",
  cv_client_id: "Client ID",
  cv_tenant_id: "Tenant ID",
  cv_redirect_uri: "Redirect URI",
...
export const de = {
  ...
  cv_section_sub: "SSO-Verbindungsdetails Ihrer Organisation anzeigen.",
  acc_my_account: "Mein Konto",
  acc_newsletter: "Newsletter",
  acc_subscriptions: "Meine Abonnements",
  acc_users: "Benutzer einladen",
  acc_billing: "Abrechnung",
  acc_help: "HILFE BENÖTIGT?",
  acc_contact: "Kontakt",
  acc_edit: "Bearbeiten",
  cv_access_title: "Ihr Zugang",
  cv_access_sub: "Die Zugangskonfiguration Ihrer Organisation. Verwaltet von Investment Officer.",
  cv_access_type_label: "Zugangsart",
  cv_client_id: "Client ID",
  cv_tenant_id: "Tenant ID",
  cv_redirect_uri: "Redirect URI",
...
export const fr = {
  ...
  cv_section_sub: "Consultez les détails de connexion SSO de votre organisation.",
  ...
  acc_edit: "Modifier",
  cv_access_title: "Votre accès",
  cv_access_sub: "La configuration d'accès de votre organisation. Gérée par Investment Officer.",
  cv_access_type_label: "Type d'accès",
  cv_client_id: "Client ID",
  cv_tenant_id: "Tenant ID",
  cv_redirect_uri: "URI de redirection",
